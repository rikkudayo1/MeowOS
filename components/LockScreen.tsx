...
const LockScreen = () => {
  ...
  return (
    <div className="absolute w-screen h-screen flex justify-center items-center z-50 backdrop-blur-3xl">
      <div className="flex flex-col items-center gap-5 -translate-y-10">
        ...
        <div className="border-2 border-[#2a2f33] rounded-full flex items-center h-[40px]">
          ...
          <button style={{ transition: ".25s" }} onClick={handleUnlock} className="pr-2 bg-[#2a2f33] h-[40px] w-[40px] pl-2 hover:scale-120 rounded-full"><ArrowBigRightDashIcon /></button>
        </div>
        <div>
